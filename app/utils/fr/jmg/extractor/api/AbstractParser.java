...
public abstract class AbstractParser implements WebParser {
    ...
    @Override
    public final void extractDescriptions(Type inType, String[] zipCodes,
            ...
            try {
                ...
                if (inType == null) {
                    for (Type type : Type.getValidTypes()) {
                        populateDescription(type, zipCode, validityThreshold,
                                result, rejected);
                    }
                } else {
                    populateDescription(inType, zipCode, validityThreshold,
                            result, rejected);
                }
     ...
     */
    protected void populateDescription(Type type, String zipCode,
            BigDecimal validityThreshold,
            Hashtable<Type, ArrayList<Description>> result,
            Hashtable<Type, ArrayList<Description>> rejected)
            throws IOException {
        ...
        for (int pageNumber = 1; pageNumber < Integer.MAX_VALUE; pageNumber++) {
            ArrayList<String> addresses = this.extractAddresses(
                    type.getNbRooms(), zipCode, pageNumber);
            ...
            for (String address : addresses) {
                ...
                Description desc = this.extractDescription(address, type,
                        zipCode, validityThreshold);
     ...
     */
    protected abstract Description extractDescription(String address,
     ...
     */
    protected abstract ArrayList<String> extractAddresses(int nbRooms,
            String zipCode, int pageNumber) throws IOException;
}
